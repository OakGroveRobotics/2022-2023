 ...
 */
public class Mecanum extends RobotDrive {
     ...
     * @param backRight  the back right motor
     */
    public Mecanum(boolean autoInvert, Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
    ...
    public void driveFieldCentric(double strafeSpeed, double forwardSpeed,
        ...
        wheelSpeeds[MotorType.kFrontLeft.value] = wheelSpeeds[MotorType.kFrontLeft.value] + turnSpeed;
        wheelSpeeds[MotorType.kFrontRight.value] = wheelSpeeds[MotorType.kFrontRight.value] + turnSpeed;
        wheelSpeeds[MotorType.kBackLeft.value] = wheelSpeeds[MotorType.kBackLeft.value] - turnSpeed;
        wheelSpeeds[MotorType.kBackRight.value] = wheelSpeeds[MotorType.kBackRight.value] - turnSpeed;
